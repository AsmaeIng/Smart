...
<div class="section">
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-lily">
        <img src="{{asset('images/gallery/12.png')}}" alt="img12" />
        <figcaption>
          <div>
            <h2>Nice
              <span>Lily</span>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-lily">
        <img src="{{asset('images/gallery/1.png')}}" alt="img1" />
        <figcaption>
          <div>
            <h2>Nice
              <span>Lily</span>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-sadie">
        <img src="{{asset('images/gallery/2.png')}}" alt="img02" />
        <figcaption>
          <h2>Holy
            <span>Sadie</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-sadie">
        <img src="{{asset('images/gallery/14.png')}}" alt="img14" />
        <figcaption>
          <h2>Holy
            <span>Sadie</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-honey">
        <img src="{{asset('images/gallery/4.png')}}" alt="img04" />
        <figcaption>
          <h2>Dreamy
            <span>Honey</span>
            <i>Now</i>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-honey">
        <img src="{{asset('images/gallery/5.png')}}" alt="img05" />
        <figcaption>
          <h2>Dreamy
            <span>Honey</span>
            <i>Now</i>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-layla">
        <img src="{{asset('images/gallery/6.png')}}" alt="img06" />
        <figcaption>
          <h2>Crazy
            <span>Layla</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-layla">
        <img src="{{asset('images/gallery/3.png')}}" alt="img03" />
        <figcaption>
          <h2>Crazy
            <span>Layla</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-zoe">
        <img src="{{asset('images/gallery/25.png')}}" alt="img25" />
        <figcaption>
          <h2>Creative
            <span>Zoe</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-zoe">
        <img src="{{asset('images/gallery/26.png')}}" alt="img26" />
        <figcaption>
          <h2>Creative
            <span>Zoe</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-oscar">
        <img src="{{asset('images/gallery/9.png')}}" alt="img09" />
        <figcaption>
          <h2>Warm
            <span>Oscar</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-oscar">
        <img src="{{asset('images/gallery/10.png')}}" alt="img10" />
        <figcaption>
          <h2>Warm
            <span>Oscar</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-marley">
        <img src="{{asset('images/gallery/11.png')}}" alt="img11" />
        <figcaption>
          <h2>Sweet
            <span>Marley</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-ruby">
        <img src="{{asset('images/gallery/13.png')}}" alt="img13" />
        <figcaption>
          <h2>Glowing
            <span>Ruby</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-roxy">
        <img src="{{asset('images/gallery/15.png')}}" alt="img15" />
        <figcaption>
          <h2>Charming
            <span>Roxy</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-roxy">
        <img src="{{asset('images/gallery/1.png')}}" alt="img01" />
        <figcaption>
          <h2>Charming
            <span>Roxy</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-bubba">
        <img src="{{asset('images/gallery/16.png')}}" alt="img16" />
        <figcaption>
          <h2>Fresh
            <span>Bubba</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-romeo">
        <img src="{{asset('images/gallery/17.png')}}" alt="img17" />
        <figcaption>
          <h2>Wild
            <span>Romeo</span>
          </h2>
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-romeo">
        <img src="{{asset('images/gallery/18.png')}}" alt="img18" />
        <figcaption>
          <h2>Wild
            <span>Romeo</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-dexter">
        <img src="{{asset('images/gallery/19.png')}}" alt="img19" />
        <figcaption>
          <h2>Strange
            <span>Dexter</span>
          </h2>
  ...
  <div class="row">
    ...
    <div class="col s12 m6 grid">
      <figure class="effect-sarah">
        <img src="{{asset('images/gallery/20.png')}}" alt="img20" />
        <figcaption>
          <h2>Free
            <span>Sarah</span>
          </h2>
...
<script src="{{asset('vendors/masonry.pkgd.min.js')}}"></script>
@endsection

{{-- -page script --}}
@section('page-script')
<script src="{{asset('js/scripts/media-hover-effects.js')}}"></script>
@endsection