        ...
        <div class="card-content">
          ...
          <div id="view-contacts">
            <div class="row">
              <div class="col s12">
                <div class="chip">
                  <img src="{{asset('images/avatar/avatar-1.png')}}" alt="Contact Person">
                  John Doe
                </div>
                <div class="chip">
                  Tag
            ...
            <div class="col s12">
              ...
              <div class="section">
                <div class="chip cyan white-text">
                  <img src="{{asset('images/logo/login-logo.png')}}" alt="Materialize"> Solid
                  color background
                </div>
              ...
              <div class="section">
                <div class="chip gradient-45deg-purple-deep-orange white-text">
                  <img src="{{asset('images/avatar/avatar-2.png')}}" alt="Materialize">
                  Gradient color background
                </div>
                <div class="chip gradient-45deg-purple-deep-orange gradient-shadow white-text">
                  <img src="{{asset('images/avatar/avatar-3.png')}}" alt="Materialize">
          ...
          <div class="row">
            ...
            <div class="col s12">
              ...
              <div class="section">
                ...
                <div class="chip cyan z-depth-4 white-text">
                  <img src="{{asset('images/logo/login-logo.png')}}" alt="Materialize">
                  Materialize Admin Theme
                  <i class="material-icons close">close</i>
                </div>
                <div class="chip gradient-45deg-purple-deep-orange white-text">
                  <img src="{{asset('images/avatar/avatar-4.png')}}" alt="Materialize">
                  Materialize Admin Theme
                  <i class="material-icons close">close</i>
                </div>
                <div class="chip gradient-45deg-purple-deep-orange gradient-shadow white-text">
            ...
            <table class="striped responsive-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Object</td>
                  <td>
                    <a href="{{asset('autocomplete')}}">Autocomplete</a> instance, if any.</td>
                </tr>
              </tbody>
            </table>
          </div>
...
{{-- page script --}}
@section('page-script')
<script src="{{asset('js/scripts/ui-chips.js')}}"></script>
@endsection