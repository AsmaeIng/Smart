    ...
    <div class="sidebar-content">
      <div class="sidebar-header">
        <div class="sidebar-details">
          <h5 class="m-0 sidebar-title"><i class="material-icons app-header-icon text-top">mode_edit</i>@lang('locale.Body')
          </h5>
        </div>
      </div>  
    </div>
      ...
      <div id="Form-advance" class="card card card-default scrollspy">
        <div class="card-content">
		  ...
		  @if ($errors->any())
							...
							@endif
          <form action="{{ route('bodys.update',$body->id) }}" method="POST">
			@csrf
			@method('PUT')
				<div class="row">
					<div class="input-field col m6 s12">
						<input type="text" id="name" name="name" value="{{ $body->name }}">
				...
				<div class="row">
					...
					<button class="waves-effect waves-light btn gradient-45deg-light-blue-cyan z-depth-4 mr-1 mb-2 left"  name="action"><a href="{{ route('bodys.index') }}"></a> @lang('locale.Retour')
