  ...
  <nav
    ...
    <div class="nav-wrapper">
        ...
        <li>
          <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
            ...
            <span class="avatar-status avatar-online">
				<img src="/{{Auth::user()->path}}" alt="avatar"><i></i>
            </span>
          </a>
        </li>
        <li>
          <a class="waves-effect waves-block waves-light sidenav-trigger" id="allusers" href="{{ route('users.allUsers') }}" data-target="slide-out-right">
      ...
      <ul class="dropdown-content" id="profile-dropdown">
        <li>
          <a class="grey-text text-darken-1" href="/page-users-edit/{{ Auth::user()->id}}">
  ...
  <li class="auto-suggestion">
    <a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar">
            <img class="circle" src="{{asset('images/avatar/avatar-9.png')}}" width="30" alt="sample image">
          </div>
          <div class="member-info display-flex flex-column">
